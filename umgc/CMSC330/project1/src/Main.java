...
import java.util.*;
import javax.swing.*;
import src.parser.LexicalError;
import src.parser.Parser;
import src.parser.SyntaxError;
 ...
 * @description Class Main: Entry point of the program. Allows user to select a scene definition
 *              file, parses it, and creates a graphical scene based on the file contents.
 * @java-version Java 17
 */

class Main {

  // The main method of the whole program, allows the name of the scene definition file to be
  // input on the
  // command line or selected using the file chooser dialog window. It calls the parser to parse
  // the scene
